// console.log('hello');
// console.error('world');
// console.warn('greetngs');

let a = 10; // inner layers scoped
var b = 20; // dont need to use anymore globally scoped
const c = 30; // cant be directly reasigned. Use for more security
